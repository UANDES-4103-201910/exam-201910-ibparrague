...
Product.create(kind: "Service",brand: 'MEC', model:'E3', variant:'Papirus',price: 100, short_description: 'Lastest from MEC', long_description: 'The latest MEC is not only the best, but it blows the other products out of the water')
